...
For convenience, the solution WcfServer has just WcfService and ConvertDocument.

How to run:

- Open and Build the solution XmlJson
	...
	- WCF: 
		1. open the WcfServerSolution and do Run (WcfService is set as startup project) - this will start the service
